...
Tags: photoblocks gallery migrator, migrate to Modula, gallery migrator, migrate from photoblocks gallery
...
4. Select the plugin zip file (modula-photoblocks-migrator.x.x.x.zip) from your computer then click the Install Now button.
